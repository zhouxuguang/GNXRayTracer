...
#ifndef PBR_CORE_MICROFACET_H
#define PBR_CORE_MICROFACET_H
...
inline std::ostream &operator<<(std::ostream &os, const MicrofacetDistribution &md)
{
    os << md.ToString();
    return os;
}
